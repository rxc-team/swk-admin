...
export class JobListComponent implements OnInit {
  cols = [
    {
      title: 'page.schedule.app',
      width: '120px'
    },
    {
      title: 'page.schedule.user',
      width: '100px'
    },
    {
      title: 'page.schedule.jobID',
      width: '180px'
    },
    {
      title: 'page.schedule.jobName',
      width: '200px'
    },
    {
      title: 'page.schedule.jobOrigin',
      width: '120px'
    },
    {
    ...
    {
      title: 'common.text.startTime',
      width: '150px'
    },
    {
      title: 'common.text.endTime',
      width: '150px'
    },
    {
      title: 'page.schedule.download'
    }
  ];
