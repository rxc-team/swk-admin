 ...
 * @Author: RXC 陳平
 * @Date: 2020-06-28 15:25:13
 * @LastEditors: RXC 陈辉宇
 * @LastEditTime: 2020-09-23 14:23:10
 */
...
@Component({
  selector: 'app-languge-mappings',
  templateUrl: './languge-mappings.component.html'
})
export class LangugeMappingsComponent implements OnInit, OnChanges {
  langCols = [
    {
