/*
 * @Description: 报表--多语言管理
 * @Author: RXC 陳平
 * @Date: 2020-06-15 15:25:13
 * @LastEditors: Rxc 陳平
 * @LastEditTime: 2020-09-14 14:59:17
 */
...
@Component({
  selector: 'app-languge-reports',
  templateUrl: './languge-reports.component.html'
})
export class LangugeReportsComponent implements OnInit, OnChanges {
  langCols = [
    {
