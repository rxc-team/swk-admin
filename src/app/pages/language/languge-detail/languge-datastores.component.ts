 ...
 * @LastEditors: RXC 陈辉宇
 * @LastEditTime: 2020-09-23 14:22:51
 */
...
@Component({
  selector: 'app-languge-datastores',
  templateUrl: './languge-datastores.component.html'
})
export class LangugeDatastoresComponent implements OnInit, OnChanges {
  langCols = [
    {
