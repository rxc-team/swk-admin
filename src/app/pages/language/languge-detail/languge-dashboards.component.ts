/*
 * @Description: 仪表盘--多语言管理
 * @Author: RXC 陳平
 * @Date: 2020-06-15 15:25:13
 * @LastEditors: Rxc 陳平
 * @LastEditTime: 2020-09-14 14:27:32
 */
...
@Component({
  selector: 'app-languge-dashboards',
  templateUrl: './languge-dashboards.component.html'
})
export class LangugeDashboardsComponent implements OnInit, OnChanges {
  langCols = [
    {
